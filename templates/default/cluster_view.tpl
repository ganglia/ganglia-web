...
<a href="./graph.php?g={$graph.name}_report&amp;z=large&amp;{$graph_args}">
<img border=0 alt="{$cluster} {$graph.name}" src="./graph.php?g={$graph.name}_report&amp;z=medium&amp;{$graph_args}">
</a>
{/foreach}
